...
<body>
    ...
    ?>
        <div class="container text-center mt-5">
            ...
            <h4>Está en modo Administrador</h4>
            <p class="mt-5">Elija una de las operaciones:</p>
            <div class=" d-grid col-7 mx-auto mt-4 gap-3">
                <a href="nuevo.php" class="btn btn-secondary btn-admin">Añadir Productos</a>
    ...
    ?>
        <div class="container text-center mt-5">
            <h1>Bienvenido de nuevo <?= $_SESSION['user'] ?></h1>
            <h4>Está en modo Editor</h4>
            <p class="mt-5">Elija una de las operaciones:</p>
            <div class=" d-grid col-7 mx-auto mt-4 gap-3">
                <a href="productos.php" class="btn btn-primary">Ir a Productos Electronicos</a>
                <a href="usuario/logout.php" class="btn btn-danger">Cerrar sesión</a>
            </div>
        </div>
    <?php
