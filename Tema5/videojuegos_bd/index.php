    ...
    ?>
        <div class="container text-center mt-5">
            ...
            <div class=" d-grid col-7 mx-auto mt-4 gap-3">
                <a href="nuevoJuego.php" class="btn btn-secondary btn-admin">Añadir Videojuegos</a>
                <a href="" class="btn btn-secondary btn-admin">Añadir Desarrolladoras</a>
     
                <a href="videojuegos.php" class="btn btn-primary">Ir a Videojuegos</a>
