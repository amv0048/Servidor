...
<body>
    <?php 
        if ($_SERVER["REQUEST_METHOD"] == 'POST'){
            ...
            if (!$errores){
                $consulta = "INSERT INTO productos_electronicos (
                    nombre,
                    descripcion,
                    categoria,
                    precio,
                ...
                $stmt->bind_param('sssdissisbs', $nombre, $descripcion, $categoria, $precio, $stock, $marca, $modelo, $garantia_meses, $especificaciones, $imagen, $fecha);
                //Ejecución
