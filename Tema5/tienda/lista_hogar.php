...
<body>
        ...
        <div class="container my-4">
            ...
            <a href="?order_by=material&direction=ASC" class="btn btn-info">Ordenar por Material</a>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            <?php 
                $query = "SELECT id_producto, nombre, descripcion, categoria, precio, stock, material, color, imagen FROM productos_hogar
                ...
                while($fila = $result->fetch_assoc()){
                    ...
                    foreach($fila as $campo => $data){
                        if ($campo != "id_producto"){
                            if ($campo == "precio") echo "<td>$data €</td>";
                            else if ($campo == "imagen") echo "<td><img src='$data' width='100' height='100'></td>";
